...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    public static class EntityTypeExtensions
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public static Navigation FindDeclaredNavigation(
            [NotNull] this IEntityType entityType,
            [NotNull] string name)
            => entityType.AsEntityType().FindDeclaredNavigation(name);
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public static IReadOnlyDictionary<string, PropertyInfo> GetRuntimeProperties([NotNull] this IEntityType entityType)
            => entityType.AsEntityType().GetRuntimeProperties();
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public static IReadOnlyList<string> GetIgnoredMembers([NotNull] this IEntityType entityType)
            => entityType.AsEntityType().GetIgnoredMembers();
        ...
        {
            var ignoredConfigurationSource = entityType.AsEntityType().FindIgnoredConfigurationSource(name);
